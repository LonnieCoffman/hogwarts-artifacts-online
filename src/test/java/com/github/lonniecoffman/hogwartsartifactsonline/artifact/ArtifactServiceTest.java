...
class ArtifactServiceTest {
    ...
    void testFindByIdNotFound(){
        ...
        // When
        Throwable thrown = catchThrowable(()-> artifactService.findById("1250808601744904193"));

        // Then
        assertThat(thrown)
                .isInstanceOf(ArtifactNotFoundException.class)
                .hasMessage("Could not find artifact with Id 1250808601744904193 :(");
        verify(artifactRepository, times(1)).findById("1250808601744904193");
    }
